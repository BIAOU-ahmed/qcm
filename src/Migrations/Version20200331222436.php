 ...
 */
final class Version20200331222436 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE question ADD id_question_precedent INT DEFAULT NULL, CHANGE qcm_id qcm_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE proposition CHANGE question_id question_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE qcm CHANGE autheur_id autheur_id INT DEFAULT NULL, CHANGE theme_id theme_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE question DROP id_question_precedent, CHANGE qcm_id qcm_id INT DEFAULT NULL');
