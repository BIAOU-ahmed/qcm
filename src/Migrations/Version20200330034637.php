 ...
 */
final class Version20200330034637 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE proposition CHANGE question_id question_id INT DEFAULT NULL, CHANGE resultat_vrai_faux resultat_vrai_faux VARBINARY(255) NOT NULL');
        $this->addSql('ALTER TABLE qcm CHANGE autheur_id autheur_id INT DEFAULT NULL, CHANGE theme_id theme_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE question CHANGE qcm_id qcm_id INT DEFAULT NULL');
