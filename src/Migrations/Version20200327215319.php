 ...
 */
final class Version20200327215319 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE proposition (id INT AUTO_INCREMENT NOT NULL, question_id INT DEFAULT NULL, libelle_proposition LONGTEXT NOT NULL, resultat_vrai_faux VARBINARY(255) NOT NULL, INDEX IDX_C7CDC3531E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, qcm_id INT DEFAULT NULL, libelle_question LONGTEXT NOT NULL, time_question TIME NOT NULL, INDEX IDX_B6F7494EFF6241A6 (qcm_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE resultat (id INT AUTO_INCREMENT NOT NULL, enseigant_id INT DEFAULT NULL, eleve_id INT DEFAULT NULL, qcm_id INT DEFAULT NULL, affectted_at DATETIME NOT NULL, realise_at DATETIME DEFAULT NULL, note NUMERIC(5, 2) DEFAULT NULL, INDEX IDX_E7DB5DE2DB4E6DF8 (enseigant_id), INDEX IDX_E7DB5DE2A6CC7B2 (eleve_id), INDEX IDX_E7DB5DE2FF6241A6 (qcm_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
